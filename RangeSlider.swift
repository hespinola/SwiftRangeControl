...
class RangeSlider: UIControl {
    ...
    final override func beginTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
    ...
    final override func continueTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
    ...
    final override func endTracking(_ touch: UITouch?, with event: UIEvent?) {
